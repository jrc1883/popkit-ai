# E606_TOOL_CRASHED - Tool crashed or terminated unexpectedly
...
Tool crashed or terminated unexpectedly

This error occurs in the **Tool Execution** category and indicates a high severity issue.
