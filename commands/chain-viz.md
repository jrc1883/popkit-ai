...
/popkit:chain-viz <workflow-id>      # Visualize specific workflow
/popkit:chain-viz <workflow-id> status # Show execution status
/popkit:chain-viz <workflow-id> metrics # Show performance metrics
