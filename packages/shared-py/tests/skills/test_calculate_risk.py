...
class TestCalculateWeightedRisk:
    ...
    def test_category_weights(self):
        ...
        assert scoring['categories']['secret-detection']['weighted_risk'] > \
    ...
    def test_unknown_category(self):
        ...
        results = [
            {'category': 'unknown-category', 'score': 50, 'findings': []}
        ]
    ...
    def test_findings_count_included(self):
        ...
        results = [
            {'category': 'secret-detection', 'score': 75, 'findings': [1, 2, 3, 4, 5]}
        ]
    ...
    def test_collect_findings_by_severity(self):
        ...
        results = [
            ...
            },
            {
                ...
                'findings': [
                    {'id': '3', 'severity': 'medium', 'name': 'SQL Injection'}
                ]
            }
        ]
        ...
        results = [
            {
                'category': 'test',
                'findings': [
                    {'id': '1', 'severity': 'invalid', 'name': 'Test'}
                ]
            }
        ]
...
class TestEdgeCases:
    ...
    def test_calculate_risk_with_negative_score(self):
        ...
        results = [
            {'category': 'secret-detection', 'score': -50, 'findings': []}
        ]
    ...
    def test_calculate_risk_with_score_over_100(self):
        ...
        results = [
            {'category': 'secret-detection', 'score': 150, 'findings': []}
        ]
