...
sys.path.insert(0, str(Path(__file__).parent.parent.parent.parent / "popkit-dev" / "skills" / "pop-nightly" / "scripts"))
...
class TestCalculateSleepScore:
    ...
    def test_zero_score_worst_case(self):
        ...
        state = {
            ...
            'github': {
                'issues': [
                    {'number': 1, 'title': 'Issue 1', 'updatedAt': '2020-01-01T00:00:00Z'}
                ],
    ...
    def test_ci_status_success(self):
        ...
        state = {
            'git': {},
            'github': {'ci_status': {'conclusion': 'success'}},
            'services': {}
        }
    ...
    def test_ci_status_failure(self):
        ...
        state = {
            'git': {},
            'github': {'ci_status': {'conclusion': 'failure'}},
            'services': {}
        }
    ...
    def test_ci_status_skipped(self):
        ...
        state = {
            'git': {},
            'github': {'ci_status': {'conclusion': 'skipped'}},
            'services': {}
        }
    ...
    def test_ci_status_pending(self):
        ...
        state = {
            'git': {},
            'github': {'ci_status': {'conclusion': 'pending'}},
            'services': {}
        }
    ...
    def test_services_stopped_some_running(self):
        ...
        state = {
            'git': {},
            'github': {},
            'services': {'running_services': ['postgres', 'redis']}
        }
...
class TestEdgeCases:
    ...
    def test_very_large_counts(self):
        ...
        state = {
            'git': {
                'uncommitted_files': 1000000,
                'merged_branches': 1000000
            },
            'github': {},
            'services': {
                'running_services': list(range(1000)),
                'log_files': 1000000
            }
        }
    ...
    def test_string_instead_of_numbers(self):
        ...
        state = {
            'git': {
                'uncommitted_files': 'many',
                'merged_branches': 'several'
            },
            'github': {},
            'services': {
                'log_files': 'lots'
