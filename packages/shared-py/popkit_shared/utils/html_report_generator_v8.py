#!/usr/bin/env python3
"""
HTML Report Generator V8 for Session Recordings

Enhanced with:
- Smart content parsing (JSON, Python dicts, plain text)
...
def format_code_content(text: str) -> str:
    ...
    # For very short text, just display as-is
    if len(text) < 50:
...
def generate_html_report(recording_file: Path, output_file: Path) -> None:
    """Generate enhanced HTML report with smart content parsing."""
