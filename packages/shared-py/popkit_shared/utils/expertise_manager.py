...
class PendingPatternsTracker:
    ...
    def __init__(self, agent_id: str, project_root: Path | None = None):
        """
        Initialize tracker.
...
class ExpertiseManager:
    ...
    def record_issue(
        self, pattern: str, severity: str, solution: str, file_path: str | None = None
    ) -> Issue | None:
        """
...
def get_manager(agent_id: str, project_root: Path | None = None) -> ExpertiseManager:
