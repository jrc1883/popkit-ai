...
def validate_all_hooks(hooks_dir: Path, sample_inputs: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    """
...
def check_hook_performance(hook_path: Path, input_data: Any, iterations: int = 10) -> Dict[str, Any]:
    """
