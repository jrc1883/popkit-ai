...
class ConflictResolver:
    ...
    def _is_architectural_conflict(self, conflict: Conflict) -> bool:
        ...
        arch_indicators = [
            ...
            "@dataclass", "def __init__", "constructor("
        ]
    ...
    def _is_breaking_conflict(self, conflict: Conflict) -> bool:
        ...
        breaking_indicators = [
            "BREAKING", "deprecated", "removed", "delete",
...
if __name__ == "__main__":
    ...
    if not conflicts:
        ...
        for i, conflict in enumerate(prioritized, 1):
            ...
            print(f"   Risk Factors: {', '.join(conflict.risk_factors) if conflict.risk_factors else 'None'}")
