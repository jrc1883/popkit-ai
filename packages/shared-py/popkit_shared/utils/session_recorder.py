...
class SessionRecorder:
    ...
    def _record_event_with_lock(self) -> None:
        ...
        try:
            ...
            print(
                f"Warning: Lock timeout for {self.recording_file}, event may be lost",
                file=sys.stderr,
            )
    ...
    def record_recommendation(
        self, recommendation_type: str, command: str, priority_score: int, reason: str
    ) -> None:
...
def record_recommendation(
    recommendation_type: str, command: str, priority_score: int, reason: str
) -> None:
