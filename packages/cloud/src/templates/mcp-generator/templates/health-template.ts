/**
 * Health Check Tools Template
 */

export const healthTemplate = `import { execa } from 'execa';
...
export const healthTools: Tool[] = [
  {
    ...
    description: 'Check if development server is running on port {{DEV_PORT}}. Returns health status and URL.',
    inputSchema: {
      type: 'object',
      properties: {},
    },
  ...
  {
    name: 'check_database',
    description: 'Check database connectivity on port {{DB_PORT}}. Returns connection status.',
    inputSchema: {
      type: 'object',
      properties: {},
    },
