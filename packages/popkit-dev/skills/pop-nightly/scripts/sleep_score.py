...
def calculate_sleep_score(state: Dict[str, Any]) -> Tuple[int, Dict[str, Dict[str, Any]]]:
    """
    ...
    sample_state = {
        ...
        'github': {
            'issues': [
                ...
                {'number': 628, 'title': 'Feature B', 'updatedAt': '2025-12-28T11:00:00Z'}
            ],
            'ci_status': {
                'conclusion': 'skipped',
                'status': 'completed'
