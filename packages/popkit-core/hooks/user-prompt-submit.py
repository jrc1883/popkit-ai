...
class UserPromptSubmitHook:
    ...
    def load_skill_triggers(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            "not working": {
                "skill": "pop-systematic-debugging",
                "enforcement": "suggest",
            },
    ...
    def route_to_orchestrator(
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(
                    f"Warning: Orchestrator routing failed: {response.status_code}",
                    file=sys.stderr,
                )
    ...
    def enhance_prompt(
        self,
        original_prompt: str,
        detected_agents: Dict,
        detected_skills: Dict,
        project_context: Dict,
        thinking_flags: Dict = None,
        ...
        if detected_agents:
            ...
            agent_count = sum(
                len(agents) for cat, agents in detected_agents.items() if cat != "meta"
            )
            if agent_count > 0:
