...
<CardGrid stagger>
  ...
  <Card title="Tiered Agent System" icon="puzzle">
    68 skills, 24 commands, and 31 agents across 3 tiers - from always-active core tools to on-demand specialists.
  </Card>
...
- **Agents**: 31 specialized agents with tiered activation
- **Skills**: 68 reusable skills in SKILL.md format
- **Commands**: 24 slash commands for common workflows
