...
- **[Session capture](https://popkit.unjoe.me/concepts/sessions/)** so you can pick up exactly where you left off
...
The ["Ready to Code" score](https://popkit.unjoe.me/features/routines/#ready-to-code-score) tells you if something needs attention before you start coding. 87 means you're good to go. 45 means something's broken.
...
```
■ [Sleep Score](https://popkit.unjoe.me/features/routines/#sleep-score): 92/100
...
Work on multiple features simultaneously with [worktree management](https://popkit.unjoe.me/reference/commands/#worktree-commands):
